...
export function Clock({ timezone }) {
  ...
  return (
    <div className="flex flex-col items-center rounded-full bg-white/[0.08] px-8 py-4 text-white/95 shadow-[0_25px_70px_-40px_rgba(11,20,45,0.7)] backdrop-blur-[1px] md:px-12">
